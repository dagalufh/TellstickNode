function get(req, res) {
  ...
  var body = [
    ...
    '<div class="form-group">',
    '<div class="checkbox">',
    '<label class="input-sm"><input type="checkbox" id="autoremote" Value="autoremote" {autoremote_selected}>AutoRemote - Send message when created schedule is triggered</label>',
    '</div>',
    '<div class="checkbox">',
    ...
    '</div>',
    '</div>',
    '<div class="panel-footer"><button class="btn btn-default btn-sm" onClick="Javascript:createwatcher(' + selected_watcher.uniqueid + ');">Save Changes</button></div>',
    '</div>'
  ];
  body = body.join("\n");
